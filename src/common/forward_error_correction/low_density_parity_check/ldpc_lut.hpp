...
constexpr std::array<std::array<uint16_t, 10>, 316> BG1_SHIFT_TABLE = {
    {
...
constexpr std::array<std::array<int16_t, BG1_ALL_CHUNKS>, BG1_LAYER_ROWS> BG1_ZERO_SHIFT_TABLE = {
    {
...
constexpr std::array<std::array<uint16_t, 10>, 197> BG2_SHIFT_TABLE = {
    {
...
constexpr std::array<std::array<int16_t, BG2_ALL_CHUNKS>, BG2_LAYER_ROWS> BG2_ZERO_SHIFT_TABLE = {
    {
